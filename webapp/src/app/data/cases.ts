...
export const CASES: AMLCase[] = [
  {
    ...
    triggerTags: ['Live data', 'Sanctioned exposure', 'High-risk outbound'],
    nodes: [],
    edges: [],
    riskFactors: [],
    sarSummary: '',
  ...
  {
    id: 'CASE-2026-0002',
    customerName: 'Meridian Logistics PLC',
    status: 'ongoing',
    riskScore: 0.74,
    entityFull: 'Meridian Logistics PLC',
    triggerTags: ['Live data', 'Structuring', 'Circular flow'],
    isLive: true,
    nodes: case1Nodes,
    edges: case1Edges,
    riskFactors: [
  ...
  {
    id: 'CASE-2026-0003',
    customerName: 'Halcyon Trading Group',
    status: 'ongoing',
    riskScore: 0.76,
    entityFull: 'Halcyon Trading Group',
    triggerTags: ['Live data', 'Sanctioned exposure', 'High-risk outbound'],
    isLive: true,
    nodes: case2Nodes,
    edges: case2Edges,
  ...
  {
    id: 'CASE-2026-0004',
    customerName: 'Sterling Bridge Holdings',
    status: 'ongoing',
    riskScore: 0.38,
    entityFull: 'Sterling Bridge Holdings',
    triggerTags: ['Live data', 'Circular flow'],
    isLive: true,
    nodes: case3Nodes,
    edges: case3Edges,
    riskFactors: [
  ...
  {
    id: 'CASE-2026-0005',
    customerName: 'Orion Freight Services Ltd',
    status: 'ongoing',
    riskScore: 1.0,
    entityFull: 'Orion Freight Services Ltd',
    triggerTags: ['Live data', 'Shell linkage', 'Sanctioned exposure'],
    isLive: true,
    nodes: case4Nodes,
    edges: case4Edges,
    riskFactors: [
  ...
  {
    id: 'CASE-2026-0006',
    customerName: 'Kingfisher Retail Group',
    status: 'ongoing',
    riskScore: 0.0,
    entityFull: 'Kingfisher Retail Group',
    triggerTags: ['Live data', 'No adverse signal'],
    isLive: true,
    nodes: case5Nodes,
    edges: case5Edges,
    riskFactors: [
